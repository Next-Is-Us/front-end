...
const Communication = () => {
  ...
  // useEffect(() => {
  //   const storeTestAccessToken = async () => {
  //     try {
  //       await AsyncStorage.setItem('accessToken', momToken);
  //       console.log('Test access token saved successfully');
  //     } catch (error) {
  //       console.error('Error saving test access token:', error);
  //     }
  //   };

  //   storeTestAccessToken();
  // }, []);
