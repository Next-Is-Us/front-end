...
export default function NFTCard({
  ...
  return (
    <>
      ...
      {back && (
        <Image
          source={require('../assets/images/NFTBack.png')}
          style={styles.card}
        />
      )}
      {front && (
        <>
          <Animated.View
            style={[
              ...
              isClicked && styles.clickedCardContainer,
              shadowStyle,
              borderStyle,
            ]}
          >
            <ImageBackground
              source={require('../assets/images/NFTContainer.png')}
              style={styles.card}
            >
              <Text style={styles.titleText}>꽃피 NFT</Text>
              <Text style={styles.recordedNumberText}>
                #{info.healthRecordId}
              </Text>
              ...
              <View style={styles.certifyTextContainer}>
                <Text style={styles.certifyText}>
                  본 NFT의 소유자는 총 {info.week} 동안
                </Text>
                <Text style={styles.certifyText}>
                  자신의 건강을 기록하였음을 인증합니다
                </Text>
              </View>
            ...
            {isClicked && (
              <>
                <Animated.View
                  style={[styles.littleShining, rightCombinedTransformStyle]}
                >
                  <LittleShining />
                </Animated.View>
                <Animated.View
                  style={[styles.leftBigShining, leftCombinedTransformStyle]}
                >
                  <LeftBigShining />
                </Animated.View>
                <Animated.View
                  style={[styles.topBigShining, topCombinedTransformStyle]}
                >
                  <TopBigShining />
                </Animated.View>
              </>
